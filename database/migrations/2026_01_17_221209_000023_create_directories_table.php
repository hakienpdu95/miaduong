...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('directories', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name', 255)->comment('Tên danh mục thư mục');
            ...
            $table->unsignedBigInteger('parent_id')->nullable()->default(NULL)->comment('Danh mục cha')->constrained('directories')->nullOnDelete();
