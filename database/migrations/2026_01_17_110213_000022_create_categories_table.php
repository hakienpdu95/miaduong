...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('categories', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('parent_id')->nullable()->default(NULL)->comment('Danh mục cha')->constrained('categories')->nullOnDelete();
            ...
            $table->boolean('is_menu')->default(false)->comment('Hiển thị trong menu navigation')->index();
