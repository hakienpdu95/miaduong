...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->timestamp('email_verified_at')->nullable()->default(NULL)->comment('Thời gian xác thực email');
            ...
            $table->text('two_factor_secret')->nullable()->default(NULL)->comment('Mã bí mật 2FA');
            $table->text('two_factor_recovery_codes')->nullable()->default(NULL)->comment('Mã khôi phục 2FA');
        ...
        DB::table('users')->updateOrInsert( ['email' => 'admin@gmail.com'], ['email' => 'admin@gmail.com','name' => 'admin','username' => 'admin','password' => Hash::make('checkvn@123!'),'email_verified_at' => Carbon::now(),'is_active' => '1'] );
    }
