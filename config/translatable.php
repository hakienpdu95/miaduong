...
return [
    ...
    */
    'locales' => [
        'vi',  // Mặc định và fallback
        'en',
        'zh' => [
            'CN',  // Trung Quốc (giản thể)
            // Thêm 'TW' nếu cần (phồn thể)
        ],
        'ko',  // Hàn Quốc
        // Giữ 'fr', 'es' nếu cần, hoặc xóa để tối ưu
        'fr',
        'es' => [
            'MX',  // Mexican Spanish
    ...
    */
    'locale' => 'vi',  // Override để mặc định 'vi' (tùy chọn; nếu null, dùng app locale)
    ...
    */
    'use_fallback' => true,  // Bật để fallback đến 'vi'
    ...
    */
    'fallback_locale' => 'vi',  // Fallback đến tiếng Việt
    ...
    */
    'to_array_always_loads_translations' => true,  // Giữ true cho tiện, nhưng set false nếu data lớn để tối ưu
    ...
    */
    'translations_wrapper' => 'translations',  // Giữ để hỗ trợ filling nested như ví dụ
];